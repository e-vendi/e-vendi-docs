...
`GET` https://e-vendi.com.br/api/getOrdersOpened?integrationToken=SEU_TOKEN&env=dev&externalId=SEU_ID
...
| externalId | string | ID da organização dentro do e-vendi |
